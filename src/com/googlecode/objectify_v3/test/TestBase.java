...
import com.googlecode.objectify_v3.cache.TriggerFutureHook;
import com.googlecode.objectify_v3.test.entity.Apple;
import com.googlecode.objectify_v3.test.entity.Banana;
import com.googlecode.objectify_v3.test.entity.Child;
import com.googlecode.objectify_v3.test.entity.Criminal;
import com.googlecode.objectify_v3.test.entity.Employee;
import com.googlecode.objectify_v3.test.entity.HasAlsoLoads;
import com.googlecode.objectify_v3.test.entity.HasArrays;
import com.googlecode.objectify_v3.test.entity.HasCollections;
import com.googlecode.objectify_v3.test.entity.HolderOfString;
import com.googlecode.objectify_v3.test.entity.HolderOfStringAndLong;
import com.googlecode.objectify_v3.test.entity.NamedTrivial;
import com.googlecode.objectify_v3.test.entity.Town;
import com.googlecode.objectify_v3.test.entity.Trivial;
	...
	public void setUp()
	{
		...
		this.fact = new ObjectifyFactory() {
			...
			public Objectify begin(ObjectifyOpts opts)
			{
				...
				// This can be used to enable/disable the session caching objectify_v3
