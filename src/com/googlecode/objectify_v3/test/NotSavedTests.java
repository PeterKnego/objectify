...
import com.googlecode.objectify_v3.condition.IfDefault;
import com.googlecode.objectify_v3.condition.IfNull;
import com.googlecode.objectify_v3.condition.IfTrue;
...
public class NotSavedTests extends TestBase
{
	...
	public void testCompletelyUnsaved() throws Exception
	{
		...
		assert fetched.foo == null;	// will fail if session caching objectify_v3 is turned on
	}
	...
	public void testDeeperUnsavedWhenTrue() throws Exception
	{
		...
		assert fetched.foo == false;	// will fail with session caching objectify_v3 turned on
		assert fetched.bar == true;
	}
