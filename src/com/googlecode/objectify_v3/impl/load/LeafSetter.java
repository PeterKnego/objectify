package com.googlecode.objectify_v3.impl.load;
...
import com.googlecode.objectify_v3.impl.LoadContext;
...
public class LeafSetter extends CollisionDetectingSetter implements ConverterLoadContext
{
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.load.CollisionDetectingSetter#safeSet(java.lang.Object, java.lang.Object, com.googlecode.objectify_v3.impl.LoadContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.conv.ConverterLoadContext#getField()
	 */
	@Override
