 ...
 * 
 * @see TypeUtils#prepareCollection(Object, com.googlecode.objectify_v3.impl.Wrapper, int)
 */
public class EmbeddedCollectionSetter extends EmbeddedMultivalueSetter
{
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.load.EmbeddedMultivalueSetter#getComponentTypeConstructor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.load.EmbeddedMultivalueSetter#getOrCreateCollection(java.lang.Object, int)
	 */
	@Override
