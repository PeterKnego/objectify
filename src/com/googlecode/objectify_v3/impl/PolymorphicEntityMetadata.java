...
public class PolymorphicEntityMetadata<T> implements EntityMetadata<T>
{
	...
	static class SubclassInfo<V>
	{
		...
		{
			if (clazz.isAnnotationPresent(com.googlecode.objectify_v3.annotation.Entity.class) || clazz.isAnnotationPresent(javax.persistence.Entity.class))
				return;
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#getKind()
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#getCacheExpirySeconds()
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#toObject(com.google.appengine.api.datastore.Entity, com.googlecode.objectify_v3.Objectify)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#toEntity(java.lang.Object, com.googlecode.objectify_v3.Objectify)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#setKey(java.lang.Object, com.google.appengine.api.datastore.Key)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#getRawKey(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#isIdField(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#isNameField(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#hasParentField()
	 */
	...
	/* (non-Javadoc)
	 * @see com.googlecode.objectify_v3.impl.EntityMetadata#getEntityClass()
	 */
	@Override
